...
# 2. Retain the highest value among duplicates
...
# Write cleaned table
write_csv(top, "C:/Users/jonan/Documents/Tyseq/Data/ForReview/Top_GSEA_Pathways_GO_filtered.csv")
...
if (nrow(pathg) >= 1) {
  ...
  ggsave("../Data/ForReview/Up-Down_GO_pathways.png", width = 12, dpi = 300)
}
...
# Clean up pathway names
top$pathway <- top$pathway %>% str_replace("KEGG+?_", "") %>% str_replace_all("_", " ")
...
# Write cleaned table
write_csv(top, "C:/Users/jonan/Documents/Tyseq/Data/ForReview/Top_GSEA_Pathways_KEGG.csv")
