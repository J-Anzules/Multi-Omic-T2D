...
tx2gene <- select(txdb, k, "GENEID", "TXNAME") # only works om 4.3.0
...
# class(results)
# 
# # Add the gene names as a new column in the results dataframe
# results$GeneName <- gene_names
# 
# # Remove the row names
# rownames(results) <- NULL
# 
# # Print the updated results dataframe with gene names as a column
# # print(results)
...
# Convert Ensemble IDs to Entrez Gene IDs
...
write.csv(gene_expression_data, "../Data/ExpressionData.csv")
...
write.csv(dfGSEA, "../Data/DGEdataframe.csv")
```
