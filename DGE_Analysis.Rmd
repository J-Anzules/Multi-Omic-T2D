...
# Saving only the significant genes based on pvalue
...
write.csv(sigGenes_p, file = "../Data/DEG_sig_genes-p.csv", row.names = FALSE)
write.csv(sigGenes_padj, file = "../Data/DEG_sig_genes-adjp.csv", row.names = FALSE)
